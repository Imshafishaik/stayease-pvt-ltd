...
<body>
    ...
    <form id="rentForm" enctype="multipart/form-data">
        ...
        <div class="form-group property_name_input">
            ...
            <input
                ...
                id="property_name"
                name="property_name"
                placeholder="e.g. Sunny Apartment in Center"
                required
            />
        </div>
  ...
  <input type="text" name="location_name" placeholder="Near Metro / Area name" required>
</div>
  ...
  <input type="text" name="pincode" placeholder="Postal Code">
        ...
        <div class="form-group description_input">
            ...
            <textarea
                ...
                placeholder="Provide a detailed description of your property (number of rooms, nearby locations, etc.)"
            ></textarea>
        </div>
